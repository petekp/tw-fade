...
const nestLum = await profileLine({
  axis: 'y',
  innerSelector: '#inner',
  body: `<div style="--tw-fade-size: 120px; --tw-fade-travel: 96px"><div id="inner" data-scroll class="fade-y panel-v">${blocks('vb', 40)}</div></div>`,
})
const nestCross = crossing(nestLum)

// 6. Mixed individual edges. This catches the cascade failure where one utility's
//    animation shorthand used to overwrite the other edge's travel animation.
